...
<h1 style="margin: 0; color: #424242; direction: ltr; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 700; letter-spacing: 1px; line-height: 150%; text-align: left; margin-top: 0; margin-bottom: 0;">ORDRE KANSELLERT</h1>
</td>
</tr>
</table>
</td>
...
<p style="margin: 0;">Du har mottatt en ordre fra <?php echo $order->get_billing_first_name().' '.$order->get_billing_last_name(); ?>. </p>
</div>
</td>
</tr>
</table>
...
<div style="color:#424242;direction:ltr;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:14px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
<p style="margin: 0;">Ordrenr<span style="color: #c2d832;"> <strong>#<?php echo $order->get_order_number(); ?>,</strong></span></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0;">
    ...
    echo $order_date; ?> <br/>Ordrestatus:  Kansellert</p>
</div>
</td>
</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" class="paragraph_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
<tr>
<td style="padding-left:10px;padding-top:27px;">
<div style="color:#4864aa;direction:ltr;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:12px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;">
<p style="margin: 0;">Ordre fra <?php echo $order->get_billing_first_name().' '.$order->get_billing_last_name(); ?> har blitt kansellert. <br/>Orderen var som følger:</p>
</div>
</td>
</tr>
</table>
