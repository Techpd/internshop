...
if ( $attachment_ids ) {
	...
	<div class="<?php echo implode( ' ', $gallery_class ); ?>"
		...
		if ( $post_thumbnail ) :
			...
			<div class="col is-nav-selected first slider-items">
				<a>
					...
					$image     = '<img src="' . $image_url . '" alt="' . $image_alt . '" width="' . $gallery_thumbnail['width'] . '" height="' . $gallery_thumbnail['height'] . '" class="attachment-woocommerce_thumbnail" />';
		...
		foreach ( $attachment_ids as $attachment_id ) {
			...
			$image     = '<img src="' . $image_url . '" alt="" width="' . $gallery_thumbnail['width'] . '" height="' . $gallery_thumbnail['height'] . '"  class="attachment-woocommerce_thumbnail" />';
