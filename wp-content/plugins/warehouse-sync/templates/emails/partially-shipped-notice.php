 ...
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/partially-shipped-notice.php.
 *
...
<p>
<?php
	printf(__('Products without custom prints have been shipped for order <strong>#%d</strong>', 'newwave'), $order->get_id());
?>
</p>
</div>
<br/>
